...
const IndexRoute: React.FC<Props> = ({clientes}) => {
  ...
  clientesConErroresDs = clientes.filter((cliente)=>  (cliente["Ds FecPre"] != "" || cliente["Ds FecPost"] != "0") && cliente["Estado"] != "down" && cliente["Calle"] != "")
  cuadrasConErroresDs = cuadrasFueraDeRango(clientes,clientesConErroresDs)
  clientesConErroresUs = clientes.filter((cliente)=>  (cliente["Us FecPre"] != "" || cliente["Us FecPost"] != "0") && cliente["Estado"] != "down" && cliente["Calle"] != "")
